	...
	wp.customize( 'background_color', function( value ) {
		value.bind( function( to ) {
			var lum = HeftyGetHexLum( to ),
				...
				stylesheetID = 'heftystartertheme-customizer-inline-styles',
				stylesheet,
				styles;
			...
			if ( ! stylesheet.length ) {
				jQuery( '#heftystartertheme-style-inline-css' ).after( '<style id="' + stylesheetID + '"></style>' );
				stylesheet = jQuery( '#' + stylesheetID );
			}
