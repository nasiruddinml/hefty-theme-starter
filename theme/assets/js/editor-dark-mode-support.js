/* global heftyIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'heftystartertheme-supports-dark-theme' ) ) {
	heftyDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function heftyDarkModeEditorInit( attempt ) {
	...
	if ( heftyIsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						heftyDarkModeEditorInit( attempt + 1 );
					},
