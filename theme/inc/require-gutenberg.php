	...
	class WPThemes_Require_Gutenberg {
		...
		public function admin_notice() {
			...
			<div class="notice notice-warning require-gutenberg-notice-wrapper notice-alt active-step-<?php echo esc_attr( $active_step ); ?>">
				<p><?php esc_html_e( 'This is an experimental theme and requires the Gutenberg plugin to be installed.', 'hefty-starter-theme' ); ?></p>
				<div class="require-gutenberg require-gutenberg-install">
					<p><?php esc_html_e( 'The Gutenberg plugin is not installed. Click the button below to install it.', 'hefty-starter-theme' ); ?></p>
					<p><button class="button" onclick="wpThemesRequireGutenberg.installPlugin();" aria-label="<?php esc_attr_e( 'Install Gutenberg', 'hefty-starter-theme' ); ?>"><?php esc_html_e( 'Install Gutenberg', 'hefty-starter-theme' ); ?></button></p>
				</div>
				<div class="require-gutenberg require-gutenberg-activate">
					<p><?php esc_html_e( 'The Gutenberg plugin is installed but not activated. Click the button below to enable the plugin.', 'hefty-starter-theme' ); ?></p>
					<p><button class="button" onclick="wpThemesRequireGutenberg.activatePlugin();"><?php esc_html_e( 'Activate Plugin.', 'hefty-starter-theme' ); ?></button></p>
				</div>
				<div class="require-gutenberg require-gutenberg-success">
					<p><?php esc_html_e( 'Congratulations! All steps required were completed. Enjoy your Full Site Editing experience.', 'hefty-starter-theme' ); ?></p>
				</div>
			</div>
			<?php
		}
			...
			wpThemesRequireGutenberg = {
				...
				installPlugin: function() {
					...
					jQuery( '.notice .require-gutenberg-install .button' )
						.html( '<?php esc_html_e( 'Installing Gutenberg...', 'hefty-starter-theme' ); ?>' )
						.addClass( 'updating-message' )
						.attr( 'aria-label', '<?php esc_attr_e( 'Installing Gutenberg...', 'hefty-starter-theme' ); ?>' );
					...
					wp.updates.installPlugin( {
						...
						error: function( e ) {
							...
							jQuery( '.require-gutenberg-install' )
								.append( '<div class="error"><p><?php esc_html_e( 'An error occured:', 'hefty-starter-theme' ); ?></p><p>' + e.message + '</p><p><?php esc_html_e( 'Please check your browser console for more details', 'hefty-starter-theme' ); ?></p></div>' );
					...
					jQuery.get( ajaxurl, {
						...
						if ( 'success' === response ) {
							...
							jQuery( '.require-gutenberg-activate' )
								.append( '<div class="error"><p><?php esc_html_e( 'An error occured', 'hefty-starter-theme' ); ?>:</p><p><?php esc_html_e( 'Could not activate the plugin. Please go to the plugins page on your dashboard and manually activate the plugin.', 'hefty-starter-theme' ); ?></p></div>' );
						}
					} );
				},
			}
