 ...
 */
return array(
	'title'      => __( 'Footer with social links and copyright', 'hefty-starter-theme' ),
	...
	'content'    => '<!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"4rem","bottom":"4rem"}}}} -->
					...
					<p class="has-text-align-center" style="font-size:16px">' . esc_html__( '© Site Title', 'hefty-starter-theme' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group -->',
);
