 ...
 */
return array(
	'title'      => __( 'Page layout with two columns', 'hefty-starter-theme' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"8rem","bottom":"8rem","right":"max(1.25rem, 5vw)","left":"max(1.25rem, 5vw)"}}},"layout":{"inherit":true}} -->
					...
					<h1 class="alignwide" style="font-size:clamp(4rem, 15vw, 12.5rem);font-weight:200;line-height:1">' . wp_kses_post( __( '<em>Goldfinch </em><br><em>&amp; Sparrow</em>', 'hefty-starter-theme' ) ) . '</h1>
					<!-- /wp:heading -->
					...
					<p>' . esc_html__( 'WELCOME', 'hefty-starter-theme' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->
					...
					<p>' . esc_html__( 'POSTS', 'hefty-starter-theme' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns -->
