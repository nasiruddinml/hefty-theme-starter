 ...
 */
return array(
	'title'      => __( 'About page with media on the left', 'hefty-starter-theme' ),
	...
	'content'    => '<!-- wp:media-text {"align":"full","mediaType":"image","imageFill":true,"focalPoint":{"x":"0.63","y":"0.16"},"backgroundColor":"foreground","className":"alignfull is-image-fill has-background-color has-text-color has-background has-link-color"} -->
					...
					<h2 id="doug-stilton-1" style="font-size:clamp(3rem, 6vw, 4.5rem);font-weight:300;line-height:1.115"><em>' . esc_html__( 'Doug', 'hefty-starter-theme' ) . '<br>' . esc_html__( 'Stilton', 'hefty-starter-theme' ) . '</em></h2>
					<!-- /wp:heading -->
